...
function LoginPage() {
  return (
    <div className="flex h-screen w-screen items-center justify-center bg-gradient-to-t from-[#F4F8FF] to-[#DBE8FF]">
      <div className="space-y-6 px-6 text-center">
        ...
        <Input
          ...
          className="h-[50px] w-[700px] rounded-xl border border-gray-200 bg-white px-4 py-3 text-sm shadow-md focus:outline-none"
        />
