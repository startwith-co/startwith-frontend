...
export default function Page() {
  ...
  if (hasSentError) {
    content = <p className="success">Sample error was sent to Sentry.</p>;
  } else if (!isConnected) {
    content = (
    ...
    content = <div className="success_placeholder" />;
  }
    ...
    <div>
      ...
      <main>
        ...
        <p className="description">
          ...
          <a
            target="_blank"
            href="https://sejong.sentry.io/issues/?project=4509208291966976"
            rel="noreferrer"
          >
            Issues Page
          </a>
