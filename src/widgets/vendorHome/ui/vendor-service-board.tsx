...
export default function VendorServiceBoard() {
  return (
    <div className="flex h-full flex-col rounded-2xl border-2 border-[#404040] px-[22.5px] py-5 text-white">
      <h2 className="mb-5 text-xl font-semibold text-white">서비스 만족도</h2>
