...
type ErrorCodeType = {
  [key: string]: { code: string; message: string; httpStatus: number };
};
...
export const ERROR_CODE: ErrorCodeType = {
  ...
  400: { code: '400', message: '잘못된 요청.', httpStatus: 400 },
  4001: {
    code: '4001',
    message: '요청에 대한 Validation 에러입니다.',
    httpStatus: 4001,
  },
  401: { code: '401', message: '인증 에러.', httpStatus: 401 },
  4011: { code: '4011', message: '인증이 만료되었습니다.', httpStatus: 4011 },
  403: { code: '403', message: '권한이 없습니다.', httpStatus: 403 },
} as const;
